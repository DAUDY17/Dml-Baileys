    ...
    return {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            if (fullMsg.message.listMessage) {
                const listMsg = fullMsg.message.listMessage;
                const sections = listMsg.sections || [];
                const title = listMsg.title || "Menu";
                const buttonText = listMsg.buttonText || "Click Here";
                const description = listMsg.description || "";
                const footer = listMsg.footerText || "";
                ...
                if (description) nativeFlowMessage.messageParamsJson = JSON.stringify({ description });
